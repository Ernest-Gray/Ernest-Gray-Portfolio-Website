...
export class EducationComponent implements OnInit {
  array = [
    ...
    },
    {
      ...
      description:
        'Through countless hours on youtube, stack-exchange, reddit and just messing around; I have created various small games.  I focusused mainly on creating procedural generative tools and intend to finish some projects over the next few years.  I have become quite apt in C# because of my extensive use of unity.',
    },
    {
